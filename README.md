...
| Версия | Главное |
|---|---|
| **v0.9.7** | **Android**: DoH-цепочка теперь зависит от активной сети — на сотовой только operator-DNS, на Wi-Fi только публичный DoH. Конец бесконечного ping-pong'а на МегаФон/MTS/Билайн (где DPI режет публичные DoH а cellular DNS периодически залипает). |
